...
// UserLastMintBlock is a free data retrieval call binding the contract method 0x3ebb032a.
//
// Solidity: function userLastMintBlock(address ) view returns(uint256)
func (_Nng *NngCaller) UserLastMintBlock(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Nng.contract.Call(opts, &out, "userLastMintBlock", arg0)
...
//
// Solidity: function userLastMintBlock(address ) view returns(uint256)
func (_Nng *NngSession) UserLastMintBlock(arg0 common.Address) (*big.Int, error) {
	return _Nng.Contract.UserLastMintBlock(&_Nng.CallOpts, arg0)
}

// UserLastMintBlock is a free data retrieval call binding the contract method 0x3ebb032a.
//
// Solidity: function userLastMintBlock(address ) view returns(uint256)
func (_Nng *NngCallerSession) UserLastMintBlock(arg0 common.Address) (*big.Int, error) {
	return _Nng.Contract.UserLastMintBlock(&_Nng.CallOpts, arg0)
}
